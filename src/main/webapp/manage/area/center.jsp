...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right5">
	...
	<div class="right">
		<div class="padding_top5 padding_left10">
			...
			<a href="javascript:;"><span class="icon_add">批量删除</span></a>
			<div class="box_tool_line"></div>
...
<div id="scrollContent" >
	...
	<table class="tableStyle"  useCheckBox="true" sortMode="true" mode="list">
		<tr>
			<th width="25">序号</th>
			<th width="50"><span  id="span_userName">片区</span></th>
			<th width="30"></th>
		</tr>
		<c:forEach items="${areaList}" var="area" varStatus="status">
		    <tr>
				...
				<td>${area.name}</td>
				<td>
				<span class="img_delete hand" title="删除"  onclick='top.Dialog.confirm("确定要删除 __${area.name}__吗",function(){location="<%=path %>/area/delete?deleteId=${area.id}"});'></span>
				</td>
		    </tr>
		</c:forEach>
...
///添加
	function addUser() {
		...
		diag.Title = "新增";
		diag.URL = "<%=path%>/manage/area/add.jsp";
		diag.Width=300;
		diag.Height=100;
		diag.show();
