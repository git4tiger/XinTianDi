...
<div class="box_tool_min padding_top2 padding_bottom2 padding_right5">
	...
	<div class="right">
		...
		<!--<a href="javascript:;" onclick="addUser()"><span class="icon_add">新增运动员</span></a>
...
<div id="scrollContent" >
	...
	<table class="tableStyle" useClick="false"  useCheckBox="false" sortMode="false">
		<tr>
			<th width="25">序号</th>
			<th width="50"><span  id="span_userName">用户名</span></th>
			<th width="25"><span  id="span_userName">密码</span></th>
			<th width="30"></th>
		</tr>
		<c:forEach items="${userInfoList}" var="userInfo" varStatus="status">
		    <tr>
				...
				<span class="img_delete hand" title="删除"  onclick='top.Dialog.confirm("确定要删除 __${userInfo.name}__吗",function(){location="<%=path %>/userInfo/delete?deleteId=${userInfo.id}"});'></span>
				</td>
		    </tr>
		</c:forEach>
...
///添加
	function addUser() {
		...
		diag.URL = "<%=path%>/manage/athlete/add.jsp";
		diag.Width=400;
		diag.Height=300;
		diag.show();
