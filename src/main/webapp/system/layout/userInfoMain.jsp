...
%>
<title>校运动会--申海梅</title>
<!--框架必需start-->
<link href="../../libs/css/import_basic.css" rel="stylesheet" type="text/css"/>
<link href="../../libs/skins/blue/style.css" rel="stylesheet" type="text/css" id="theme" themeColor="blue"/>
<link href="../../system/layout/skin/style.css" rel="stylesheet" type="text/css" id="skin"  skinPath="system/layout/skin/"/>
	...
	<div id="bs_navright">
		<div class="bs_nav">
			...
			<div class="float_right padding_top2 padding_right5">
				...
				<span class="icon_no hand" onclick='top.Dialog.confirm("确定要退出系统吗",function(){window.location="<%=path%>/login/logout.action"});'>退出系统</span>
			</div>
			<div class="clear"></div>
		</div>
	</div>
		...
		<td id="hideCon" class="ver01 ali01">
							<div id="lbox">
								...
								<div id="lbox_middleright">
										<div id="bs_left">
										<IFRAME scrolling="no" width="100%"  frameBorder=0 id=frmleft name=frmleft src="userInfoleft.html"  allowTransparency="true"></IFRAME>
										</div>
		...
		<td class="ali01 ver01"  width="100%">
							<div id="rbox">
								...
								<div id="rbox_middleright">
									<div id="bs_right">
									       <IFRAME scrolling="no" width="100%" frameBorder=0 id=frmright name=frmright src="open.html"  allowTransparency="true"></IFRAME>
									</div>
								</div>
								</div>
								</div>
